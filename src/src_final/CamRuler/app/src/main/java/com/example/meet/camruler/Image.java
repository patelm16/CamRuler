...
public class Image extends MainActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //everytime the ok button is pressed
        btnOK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //looks at the size of contained circles to contraint the user to drawing points untill they confirm
    ...
    /**
     * Creates the image file on phone storage and returns it
    ...
    /**
     * Create a dialog box with the length of the object
     */
